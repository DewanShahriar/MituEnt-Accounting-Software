        ...
        <div class="col-md-12">
            ...
            <div class="box box-warning box-solid">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="box-shadow: 1px 1px 15px 5px #f39c12; margin: 10px 30px 40px 25px; padding: 30px 0px 30px 0px;">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select name="category" id="" class="form-control select2 inner_shadow_orange" >
                                                ...
                                                <option value="2" <?php if ($edit_info->category == 2) echo 'selected' ; ?> > <?php echo $this->lang->line('both'); ?> </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select name="category" id="" class="form-control select2">
                                                ...
                                                <option value="2"><?php echo $this->lang->line('both'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#both" data-toggle="tab"><?php echo $this->lang->line('both'); ?></a></li>
