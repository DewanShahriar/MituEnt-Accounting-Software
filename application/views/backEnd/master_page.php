        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="<?php echo base_url(); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>Mitu </b> Ent</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php if ($activeMenu === "customer_add" || $activeMenu === "customer_list" || $activeMenu === "customer_edit") echo "active"; ?> ">
                            <a href="#">
                            <i class="fa fa-user"></i> <span> <?php echo $this->lang->line('customer_manage'); ?> </span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class=" <?php if ($activeMenu === "customer_add") echo "active"; ?> "><a href="<?php echo base_url('admin/customer/add'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('customer_add'); ?> </a></li>
                                <li class=" <?php if ($activeMenu === "customer_list") echo "active"; ?> "><a href="<?php echo base_url('admin/customer/list'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('customer_list'); ?> </a></li>
                        ...
                        <li class="treeview <?php if ($activeMenu === "customer_balance_add" || $activeMenu === "customer_balance_list" || $activeMenu === "customer_balance_edit" || $activeMenu === "customer_balance_report") echo "active"; ?> ">
                            <a href="#">
                            <i class="fa fa-bar-chart"></i> <span> <?php echo $this->lang->line('customer_balance'); ?> </span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?php if ($activeMenu === "customer_balance_add") echo "active"; ?> "><a href="<?php echo base_url('admin/customer-balance/add'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('customer_balance_add'); ?> </a></li>
                                <li class="<?php if ($activeMenu === "customer_balance_list") echo "active"; ?> "><a href="<?php echo base_url('admin/customer-balance/list'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('customer_balance_list'); ?> </a></li>
                                <li class="<?php if ($activeMenu === "customer_balance_report") echo "active"; ?> "><a href="<?php echo base_url('admin/customer-balance/report'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('customer_balance_report'); ?> </a></li>
                        ...
                        <!-- transaction medium start-->

                        <li class="treeview <?php if ($activeMenu === "transaction_medium_add" || $activeMenu === "transaction_medium_list" || $activeMenu === "transaction_medium_edit" || $activeMenu === "salary_add" || $activeMenu === "salary_list" || $activeMenu === "salary_report") echo "active"; ?> ">
                            <a href="#">
                            <i class="fa fa-cc-paypal"></i> <span> <?php echo $this->lang->line('transaction_medium'); ?> </span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class=" <?php if ($activeMenu === "transaction_medium_add") echo "active"; ?> "><a href="<?php echo base_url('admin/transaction-medium/add'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('transaction_medium_add'); ?> </a></li>
                                <li class=" <?php if ($activeMenu === "transaction_medium_list") echo "active"; ?> "><a href="<?php echo base_url('admin/transaction-medium/list'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line('transaction_medium_list'); ?> </a></li>
                                
                            </ul>
                        </li>

                        <!-- transaction medium end-->
                        ...
                        <!-- Report MANAGE -->
                        <li class="treeview <?php if ($activeMenu === "report_manage" || $activeMenu === "daily_summary" || $activeMenu === "balance_sheet" || $activeMenu === "trial_balance") echo "active"; ?> ">
                            <a href="#">
                            <i class="fa fa-file-pdf-o"></i> <span> <?php echo $this->lang->line("report_manage"); ?> </span>
                            <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class=" <?php if ($activeMenu === "daily_summary") echo "active"; ?> "><a href="<?php echo base_url('admin/daily-summary'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line("daily_summary"); ?> </a></li>
                                <li class=" <?php if ($activeMenu === "balance_sheet") echo "active"; ?> "><a href="<?php echo base_url('admin/balance-sheet'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line("balance_sheet"); ?> </a></li>
                                <li class=" <?php if ($activeMenu === "trial_balance") echo "active"; ?> "><a href="<?php echo base_url('admin/trial-balance'); ?>"><i class="fa fa-circle-o"></i> <?php echo $this->lang->line("trial_balance"); ?> </a></li>
                            </ul>
                        </li>
