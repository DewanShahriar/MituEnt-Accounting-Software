        ...
        <div class="col-xs-12">
            <div class="box box-info box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $this->lang->line('balance_sheet'); ?></h3>
                    <div class="box-tools pull-right">
                        
                    </div>
                </div>
                <div class="row" style="box-shadow: 0px 0px 10px 0px #00c0ef; margin: 8px 53px 20px 55px; padding:20px 4px 20px 4px;">
                   <form action="<?php echo base_url('admin/balance-sheet') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="col-md-12">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label> <br> </label>
                                        <?php if($print){?>
                                        <a href="<?php echo base_url('admin/balance-sheet-print?start_date='.$search['start_date'].'&end_date='.$search['end_date']) ?>" target="_blank" class="btn bg-green btn-sm"><i class="fa fa-print"></i> <?php echo $this->lang->line('print'); ?></a>
                                    <?php }?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table id="userListTable" class="table table-bordered table-striped table_th_info">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 75%;"><?php echo $this->lang->line('account_head'); ?></th>
